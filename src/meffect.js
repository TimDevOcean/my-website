...
function getWebGLContext(e) {
    ...
    i || (t = e.getContext("webgl", r) || e.getContext("experimental-webgl", r)),
        i ? (t.getExtension("EXT_color_buffer_float"), (o = t.getExtension("OES_texture_float_linear"))) : ((n = t.getExtension("OES_texture_half_float")), (o = t.getExtension("OES_texture_half_float_linear"))),
        t.clearColor(0, 0, 0, 1);
    const a = i ? t.HALF_FLOAT : n.HALF_FLOAT_OES;
    let l, u, c;
    return (
        i
            ? ((l = getSupportedFormat(t, t.RGBA16F, t.RGBA, a)), (u = getSupportedFormat(t, t.RG16F, t.RG, a)), (c = getSupportedFormat(t, t.R16F, t.RED, a)))
            : ((l = getSupportedFormat(t, t.RGBA, t.RGBA, a)), (u = getSupportedFormat(t, t.RGBA, t.RGBA, a)), (c = getSupportedFormat(t, t.RGBA, t.RGBA, a))),
...
function createProgram(e, r) {
    ...
    return gl.attachShader(t, e), gl.attachShader(t, r), gl.linkProgram(t), gl.getProgramParameter(t, gl.LINK_STATUS) || console.trace(gl.getProgramInfoLog(t)), t;
}
...
function compileShader(e, r, t) {
    ...
    return gl.shaderSource(i, r), gl.compileShader(i), gl.getShaderParameter(i, gl.COMPILE_STATUS) || console.trace(gl.getShaderInfoLog(i)), i;
}
...
const baseVertexShader = compileShader(
    ...
    blit = (() => (
        ...
        (e, r = !1) => {
            null == e ? (gl.viewport(0, 0, gl.drawingBufferWidth, gl.drawingBufferHeight), gl.bindFramebuffer(gl.FRAMEBUFFER, null)) : (gl.viewport(0, 0, e.width, e.height), gl.bindFramebuffer(gl.FRAMEBUFFER, e.fbo)),
...
function initFramebuffers() {
    ...
    gl.disable(gl.BLEND),
        (dye = null == dye ? createDoubleFBO(r.width, r.height, i.internalFormat, i.format, t, a) : resizeDoubleFBO(dye, r.width, r.height, i.internalFormat, i.format, t, a)),
        (velocity = null == velocity ? createDoubleFBO(e.width, e.height, n.internalFormat, n.format, t, a) : resizeDoubleFBO(velocity, e.width, e.height, n.internalFormat, n.format, t, a)),
...
function createFBO(e, r, t, i, n, o) {
    ...
    gl.bindTexture(gl.TEXTURE_2D, a),
        ...
        gl.texImage2D(gl.TEXTURE_2D, 0, t, e, r, 0, i, n, null);
...
function resizeFBO(e, r, t, i, n, o, a) {
    ...
    return copyProgram.bind(), gl.uniform1i(copyProgram.uniforms.uTexture, e.attach(0)), blit(l), l;
}
function resizeDoubleFBO(e, r, t, i, n, o, a) {
    return e.width == r && e.height == t ? e : ((e.read = resizeFBO(e.read, r, t, i, n, o, a)), (e.write = createFBO(r, t, i, n, o, a)), (e.width = r), (e.height = t), (e.texelSizeX = 1 / r), (e.texelSizeY = 1 / t), e);
}
...
function multipleSplats(e) {
    for (let r = 0; r < e; r++) {
        ...
        (e.r *= 10), (e.g *= 10), (e.b *= 10), splat(Math.random(), Math.random(), 100 * (Math.random() - 0.5), 400 * (Math.random() - 0.5), e);
    }
}
...
function render(e) {
    (null != e && config.TRANSPARENT) || (gl.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA), gl.enable(gl.BLEND)), drawDisplay(e);
}
...
function splat(e, r, t, i, n) {
    splatProgram.bind(),
        gl.uniform1i(splatProgram.uniforms.uTarget, velocity.read.attach(1)),
        gl.uniform1f(splatProgram.uniforms.aspectRatio, canvas.width / canvas.height),
        gl.uniform2f(splatProgram.uniforms.point, e, r),
        gl.uniform3f(splatProgram.uniforms.color, t, i, 0),
        gl.uniform1f(splatProgram.uniforms.radius, correctRadius(config.SPLAT_RADIUS / 150)),
        blit(velocity.write),
        velocity.swap(),
        gl.uniform1i(splatProgram.uniforms.uTarget, dye.read.attach(0)),
        gl.uniform3f(splatProgram.uniforms.color, 0.03, 0.03, 0.03),
        blit(dye.write),
        dye.swap();
}
function splat2(e, r, t, i, n) {
    splatProgram.bind(),
        gl.uniform1i(splatProgram.uniforms.uTarget, velocity.read.attach(0)),
        gl.uniform1f(splatProgram.uniforms.aspectRatio, canvas.width / canvas.height),
        gl.uniform2f(splatProgram.uniforms.point, e, r),
        gl.uniform3f(splatProgram.uniforms.color, t, i, 0),
        gl.uniform1f(splatProgram.uniforms.radius, correctRadius(config.SPLAT_RADIUS / 25e3)),
        blit(velocity.write),
        velocity.swap(),
        gl.uniform1i(splatProgram.uniforms.uTarget, dye.read.attach(0)),
        gl.uniform3f(splatProgram.uniforms.color, 0.015, 0.015, 0.015),
        blit(dye.write),
        dye.swap();
}
...
function generateColor() {
    let e = HSVtoRGB(0.1, 1, 1);
    return (e.r *= 0.25), (e.g *= 0.16), (e.b *= 0.16), e;
}
